...
<div class="card">
    <div class="card-header">
        <div class="card-title">Form Tambah Detail</div>
        <div class="card-tools">
            <a href="<?= base_url(); ?>/detailpengajuan/detail/<?=$detail['pengajuan_id']?>" class="btn btn-sm btn-default"><i class="fa fa-chevron-left"></i> Batal</a>
    ...
    <div class="card-body">
        <input type="hidden" name="pengajuan_id" value="<?= set_value('pengajuan_id', $detail['pengajuan_id']); ?>">
        ...
        <div class="form-group">
            ...
            <select class="form-control select2 <?= $validation->hasError('produk_id') ? 'is-invalid' : ''; ?>" name="produk_id" id="produk_id">
                ...
                <option value="<?= $p['produk_id']; ?>" <?= set_select('produk_id', $p['produk_id']); ?>>
            ...
            <span class="text-muted small">Silahkan refresh halaman jika produk tidak muncul setelah diinput</span>
        </div>
        <div class="row row-cols-1 row-cols-sm-2">
            <div class="col">
                <div class="form-group">
                    ...
                    <ul id="jenis-wrapper" class="list-group list-group-flush"></ul>
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <ul id="negara-wrapper" class="list-group list-group-flush"></ul>
                    <div class="small text-danger">
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input placeholder="Unit" class="form-control <?= $validation->hasError('jumlah') ? 'is-invalid' : ''; ?>" value="<?= old('jumlah'); ?>" type="text" name="jumlah" id="jumlah">
                    <div class="invalid-feedback">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input placeholder="Volume (m3)" class="form-control <?= $validation->hasError('volume') ? 'is-invalid' : ''; ?>" value="<?= old('volume'); ?>" type="text" name="volume" id="volume">
                    <div class="invalid-feedback">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input placeholder="Berat (kg)" class="form-control <?= $validation->hasError('berat') ? 'is-invalid' : ''; ?>" value="<?= old('berat'); ?>" type="text" name="berat" id="berat">
                    <div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input placeholder="Nilai" class="form-control <?= $validation->hasError('nilai') ? 'is-invalid' : ''; ?>" value="<?= old('nilai'); ?>" type="text" name="nilai" id="nilai">
                <div class="invalid-feedback">
