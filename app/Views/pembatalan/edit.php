...
<?= csrf_field(); ?>
<input type="hidden" name="pembatalan_id" value="<?=$pembatalan['pembatalan_id']?>">
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card card-outline card-lightblue">
            <div class="card-header">
                <h5 class="card-title mt-1">
                    Edit Pembatalan Dokumen
                </h5>
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input value="<?= old('no_dokumen', $pembatalan['no_dokumen']); ?>" required minlength="24" maxlength="24" type="text" placeholder="<?= date('y') ?>.00000-00000.007.XX-XX" name="no_dokumen" id="no_dokumen" class="form-control <?= $validation->hasError('no_dokumen') ? 'is-invalid' : ''; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input value="<?= old('no_invoice', $pembatalan['no_invoice']); ?>" type="text" placeholder="Nomor Invoice yang sebelumnya (jika ganti)" name="no_invoice" id="no_invoice" class="form-control <?= $validation->hasError('no_invoice') ? 'is-invalid' : ''; ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea maxlength="255" placeholder="Alasan Pembatalan" name="keterangan" id="keterangan" rows="3" class="form-control <?= $validation->hasError('keterangan') ? 'is-invalid' : ''; ?>"><?= old('keterangan', $pembatalan['keterangan']); ?></textarea>
                        <div class="invalid-feedback">
