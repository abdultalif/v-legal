...
<div class="row justify-content-center">
    <div class="col-md-4">
        <div class="card card-outline card-primary">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <?= form_open('pejabat/save'); ?>
                <?= csrf_field(); ?>
                <div class="form-group">
                    <label for="kode_pejabat">Kode Pejabat</label>
                    <input class="form-control <?= $validation->hasError('kode_pejabat') ? 'is-invalid' : ''; ?>" value="<?= old('kode_pejabat'); ?>" type="text" name="kode_pejabat" id="kode_pejabat">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?= $validation->hasError('nama_pejabat') ? 'is-invalid' : ''; ?>" value="<?= old('nama_pejabat'); ?>" type="text" name="nama_pejabat" id="nama_pejabat">
                    <div class="invalid-feedback">
